...
class ColorPorLetrasv2(Scene): #explicar y modificar x por {x}
	def construct(self):
		texto = TexMobject("{d","\\over","d","x","}","\\int_","{0}^","{","x","}","f(","x",")d","x")
		texto.set_color_by_tex("x",RED)
